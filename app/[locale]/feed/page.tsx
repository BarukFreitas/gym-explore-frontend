...
export default function FeedPage() {
  ...
  const handleDeletePost = useCallback(async (postId: number) => {
    ...
    try {
      ...
      refetchPosts();
      alert(t("postDeletedSuccess"));
    } catch (err: any) {
      console.error("Erro ao excluir post:", err);
      alert((err as ErrorResponse)?.error || t("postDeletedError"));
    }
  ...
  return (
    // Adicione a classe 'bg-black' aqui para definir o fundo
    <div className="relative w-full min-h-screen bg-black">
      {/* Componente Image para o fundo */}
      <Image
        ...
        objectFit="cover"
        priority
        className="fixed inset-0 z-0 opacity-20" // Mantenha a opacidade desejada
      />

      {/* Conteúdo da página - continua com z-index maior e rolagem */}
