...
import { useSendContactFormMutation } from '@/app/store/gymsApi';
  ...
  return (
      <form onSubmit={handleSubmit} className="bg-gray-800 p-8 rounded-lg shadow-xl border border-gray-700">
        ...
        <div className="mb-6">
          ...
          <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} className={`w-full px-4 py-3 bg-gray-700 text-white rounded-md border focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-200 ${formErrors.name ? 'border-red-500' : 'border-gray-600'}`} placeholder={t('namePlaceholder')} />
        ...
        <div className="mb-6">
          ...
          <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} className={`w-full px-4 py-3 bg-gray-700 text-white rounded-md border focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-200 ${formErrors.email ? 'border-red-500' : 'border-gray-600'}`} placeholder={t('emailPlaceholder')} />
        ...
        <div className="mb-6">
          ...
          <input type="text" id="subject" name="subject" value={formData.subject} onChange={handleChange} className={`w-full px-4 py-3 bg-gray-700 text-white rounded-md border focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-200 ${formErrors.subject ? 'border-red-500' : 'border-gray-600'}`} placeholder={t('subjectPlaceholder')} />
        ...
        <div className="mb-8">
          ...
          <textarea id="message" name="message" value={formData.message} onChange={handleChange} rows={6} className={`w-full px-4 py-3 bg-gray-700 text-white rounded-md border focus:outline-none focus:ring-2 focus:ring-green-500 transition duration-200 ${formErrors.message ? 'border-red-500' : 'border-gray-600'}`} placeholder={t('messagePlaceholder')}></textarea>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <button
              type="submit"
              className="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-8 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition-colors duration-300 w-full sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={isLoading}
          >
